...
#ifndef CPCOREKIT_SWIFT_H
#define CPCOREKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CPCoreKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// automatically.
SWIFT_CLASS("_TtC9CPCoreKit21AsynchronousOperation")
...
/// Whether the operation is Asynch
@property (nonatomic, readonly, getter=isAsynchronous) BOOL asynchronous;
/// Starts the AsynchOperation
- (void)start;
...
/// <code>finish()</code> when they are done. All <code>NSOperation</code> work will be handled
/// automatically.
SWIFT_CLASS("_TtC9CPCoreKit23CPAsynchronousOperation")
@interface CPAsynchronousOperation : NSOperation
@property (nonatomic, readonly, getter=isReady) BOOL ready;
@property (nonatomic, readonly, getter=isExecuting) BOOL executing;
@property (nonatomic, readonly, getter=isFinished) BOOL finished;
@property (nonatomic, readonly, getter=isAsynchronous) BOOL asynchronous;
/// Starts the asynch operation
- (void)start;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC9CPCoreKit6CPHTTP")
@interface CPHTTP : NSObject <NSURLSessionDelegate>
...
@interface CPHTTP (SWIFT_EXTENSION(CPCoreKit)) <NSURLSessionDataDelegate>
...
SWIFT_CLASS("_TtC9CPCoreKit12CPHTTPResult")
...
SWIFT_PROTOCOL("_TtP9CPCoreKit17CPImageDisplaying_")
@protocol CPImageDisplaying
...
/// CloudPayments-maintained version of DialCountries
/// <ul>
///   <li>
///     See https://github.com/ahmedAlmasri/DialCountries for documentation
///   </li>
/// </ul>
SWIFT_CLASS("_TtC9CPCoreKit23DialCountriesController")
...
SWIFT_CLASS("_TtC9CPCoreKit12QRCodeReader")
...
/// CloudPayments-maintained QRCodeReaderView
/// <ul>
///   <li>
///     Visit http://yannickloriot.com for information
///   </li>
/// </ul>
SWIFT_CLASS("_TtC9CPCoreKit16QRCodeReaderView")
...
SWIFT_CLASS("_TtC9CPCoreKit26QRCodeReaderViewController")
...
SWIFT_CLASS("_TtC9CPCoreKit17ReaderOverlayView")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC9CPCoreKit18SwitchCameraButton")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC9CPCoreKit17ToggleTorchButton")
...
@interface UIButton (SWIFT_EXTENSION(CPCoreKit))
...
@interface UIImageView (SWIFT_EXTENSION(CPCoreKit)) <CPImageDisplaying>
/// Displays an image.
- (void)nuke_displayWithImage:(UIImage * _Nullable)image;
@end
...
@interface UITextField (SWIFT_EXTENSION(CPCoreKit))
...
@interface UIView (SWIFT_EXTENSION(CPCoreKit))
